...
function PagerLink({
  ...
  return (
    <Link
      ...
      className={cn(
        "group flex min-w-0 flex-1 basis-56 items-center gap-2.5 rounded-[3px] border border-rule bg-surface px-3.5 py-3 transition-colors outline-none hover:border-accent focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 focus-visible:ring-offset-paper",
    ...
    >
      ...
      <span className="min-w-0">
        ...
        <span className="block truncate font-mono text-[0.74rem] text-ink">
